    ...
    <CCol col>
      <CCard>
        <CCardHeader>
            <div class="row">
                <div class="col-md-6">
                    <CIcon name="cil-justify-center"/><strong> Ads Work List</strong>
                </div>
                <div class="col-md-6">
...
export default {
    ...
    computed: {
        ...
        fields () {
            const labels = [
                ...
                { label: 'Title', class: 'text-center' },
                { label: 'Ads Network', class: 'text-center' },
                { label: 'VPN', class: 'text-center' },
    ...
    methods: {
        ...
        toggleStatus (item, statusId) {
            RestApi.putData(baseUrl, `api/ads-works/status/${item.id}`, { status: statusId }).then(response => {
                if (response.success) {
        ...
        loadData () {
            ...
            RestApi.getData(baseUrl, 'api/ads-works/list', params).then(response => {
                if (response.success) {
