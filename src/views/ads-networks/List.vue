    ...
    <CCol col>
      <CCard>
        <CCardHeader>
            <div class="row">
                <div class="col-md-6">
                    <CIcon name="cil-justify-center"/><strong> Ads Networks</strong>
                </div>
                <div class="col-md-6">
...
export default {
    ...
    computed: {
        ...
        fields () {
            const labels = [
                ...
                { label: 'Ads Name', class: 'text-left' },
                { label: 'App ID', class: 'text-left' },
    ...
    methods: {
        ...
        toggleStatus (item, statusId) {
            RestApi.putData(baseUrl, `api/ads-networds/status/${item.id}`, { status: statusId }).then(response => {
                if (response.success) {
        ...
        loadData () {
            ...
            RestApi.getData(baseUrl, 'api/ads-networds/list', params).then(response => {
                if (response.success) {
