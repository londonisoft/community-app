<template>
  <div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="card">
                            <div class="card-body d-flex align-items-center p-0">
                                ...
                                <div>
                                <div class="text-muted text-uppercase font-weight-bold"> Total </div>
                                <div class="text-value text-gradient-primary">{{ parseFloat(formData.total_user).toFixed(2) }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <CRow>
      <CCol sm="12" md="12">
        <CCard accent-color="success">
          <CCardHeader><b> Work Summary</b></CCardHeader>
            <CCardBody>
                <div class="row">
                    <div class="col-12 col-sm-6 col-lg-2">
                        <div class="card">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="card">
                            <div class="card-body d-flex align-items-center p-0">
                                ...
                                <div>
                                <div class="text-muted text-uppercase font-weight-bold"> Total </div>
                                <div class="text-value text-gradient-primary">{{ parseFloat(formData.total_click).toFixed(2) }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="card">
                            <div class="card-body d-flex align-items-center p-0">
                                ...
                                <div>
                                <div class="text-muted text-uppercase font-weight-bold"> Total </div>
                                <div class="text-value text-gradient-primary">{{ parseFloat(formData.total_point).toFixed(2) }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
