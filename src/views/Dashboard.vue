                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="card">
                            <div class="card-body d-flex align-items-center p-0">
                                ...
                                <div>
                                <div class="text-muted text-uppercase font-weight-bold"> Total Payable </div>
                                <div class="text-value text-gradient-primary">{{ parseFloat(formData.total_payable).toFixed(2) }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
